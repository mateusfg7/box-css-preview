  ...
  return (
    <div id="main-box-area">
      <span className="box-size">
        {boxSize.width}x{boxSize.heigth}px
      </span>
      <div id="main-box" />
      <div className="size-change">
        <section>
          ...
          <span
            ...
            onClick={() => changeBoxSize("width-minus", boxSize, setBoxSize)}
          >
            {ico(faMinusSquare)}
          </span>
          ...
          <span
            ...
            onClick={() => changeBoxSize("width-plus", boxSize, setBoxSize)}
          >
            {ico(faPlusSquare)}
          </span>
        </section>
        <section>
          ...
          <span
            ...
            onClick={() => changeBoxSize("height-minus", boxSize, setBoxSize)}
          >
            {ico(faMinusSquare)}
          </span>
          ...
          <span
            ...
            onClick={() => changeBoxSize("height-plus", boxSize, setBoxSize)}
          >
            {ico(faPlusSquare)}
          </span>
        </section>
